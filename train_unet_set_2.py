...
def main():
    ...
    hyperparameter_sets = [
    {'model_name': 'Unet_deeper', 'optimizer_name': 'rmsprop', 'learning_rate': 0.00421, 'dropout_rate': 0.25, 'l2_lambda': 0.00718, 'activation_function': 'relu', 'loss_function': 'binary_crossentropy', 'momentum': 0.2},
    {'model_name': 'Unet', 'optimizer_name': 'adam', 'learning_rate': 0.00201, 'dropout_rate': 0.2, 'l2_lambda': 0.00392, 'activation_function': 'leaky_relu', 'loss_function': 'dice_loss', 'momentum': 0.0},
    {'model_name': 'Unet_shallow', 'optimizer_name': 'adam', 'learning_rate': 0.00015, 'dropout_rate': 0.1, 'l2_lambda': 0.00006, 'activation_function': 'relu', 'loss_function': 'dice_loss', 'momentum': 0.5},
    {'model_name': 'Unet_wide', 'optimizer_name': 'sgd', 'learning_rate': 0.00627, 'dropout_rate': 0.4, 'l2_lambda': 0.00007, 'activation_function': 'relu', 'loss_function': 'dice_loss', 'momentum': 0.6},
    {'model_name': 'Unet_shallow', 'optimizer_name': 'rmsprop', 'learning_rate': 0.00147, 'dropout_rate': 0.1, 'l2_lambda': 0.00299, 'activation_function': 'leaky_relu', 'loss_function': 'dice_loss', 'momentum': 0.4},
    {'model_name': 'Unet_wide', 'optimizer_name': 'adam', 'learning_rate': 0.01068, 'dropout_rate': 0.4, 'l2_lambda': 0.03491, 'activation_function': 'leaky_relu', 'loss_function': 'dice_loss', 'momentum': 0.2},
    {'model_name': 'Unet', 'optimizer_name': 'rmsprop', 'learning_rate': 0.00023, 'dropout_rate': 0.2, 'l2_lambda': 0.00204, 'activation_function': 'leaky_relu', 'loss_function': 'binary_crossentropy', 'momentum': 0.5},
    {'model_name': 'Unet_simple', 'optimizer_name': 'rmsprop', 'learning_rate': 0.00007, 'dropout_rate': 0.3, 'l2_lambda': 0.00003, 'activation_function': 'relu', 'loss_function': 'binary_crossentropy', 'momentum': 0.5},
    {'model_name': 'Unet_deeper', 'optimizer_name': 'rmsprop', 'learning_rate': 0.00030, 'dropout_rate': 0.2, 'l2_lambda': 0.00046, 'activation_function': 'relu', 'loss_function': 'dice_loss', 'momentum': 0.9},
    {'model_name': 'Unet_deeper', 'optimizer_name': 'rmsprop', 'learning_rate': 0.00612, 'dropout_rate': 0.25, 'l2_lambda': 0.00917, 'activation_function': 'relu', 'loss_function': 'dice_loss', 'momentum': 0.1},
    {'model_name': 'Unet_deeper', 'optimizer_name': 'adam', 'learning_rate': 0.00006, 'dropout_rate': 0.1, 'l2_lambda': 0.00053, 'activation_function': 'relu', 'loss_function': 'binary_crossentropy', 'momentum': 0.3},
    {'model_name': 'Unet_shallow', 'optimizer_name': 'rmsprop', 'learning_rate': 0.00048, 'dropout_rate': 0.4, 'l2_lambda': 0.00322, 'activation_function': 'relu', 'loss_function': 'binary_crossentropy', 'momentum': 0.7},
    {'model_name': 'Unet_shallow', 'optimizer_name': 'rmsprop', 'learning_rate': 0.00007, 'dropout_rate': 0.1, 'l2_lambda': 0.00006, 'activation_function': 'relu', 'loss_function': 'dice_loss', 'momentum': 0.7},
    {'model_name': 'Unet_deeper', 'optimizer_name': 'rmsprop', 'learning_rate': 0.00011, 'dropout_rate': 0.1, 'l2_lambda': 0.00010, 'activation_function': 'leaky_relu', 'loss_function': 'dice_loss', 'momentum': 0.2},
    {'model_name': 'Unet', 'optimizer_name': 'rmsprop', 'learning_rate': 0.00025, 'dropout_rate': 0.1, 'l2_lambda': 0.00001, 'activation_function': 'relu', 'loss_function': 'dice_loss', 'momentum': 0.6}
]


    # Directory to save results
    result_dir = 'results/learning/unet_set_2'

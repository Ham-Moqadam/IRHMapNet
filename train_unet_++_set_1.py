...
def main():
    ...
    hyperparameter_sets = [
    {'model_name': 'Unet_wide', 'optimizer_name': 'adam', 'learning_rate': 7.3185E-04, 'dropout_rate': 0.1, 'l2_lambda': 2.3074E-05, 'activation_function': 'relu', 'loss_function': 'dice_loss', 'momentum': 0.9},
    {'model_name': 'Unet_deeper', 'optimizer_name': 'rmsprop', 'learning_rate': 1.0373E-05, 'dropout_rate': 0.2, 'l2_lambda': 1.2470E-05, 'activation_function': 'leaky_relu', 'loss_function': 'binary_crossentropy', 'momentum': 0.6},
    {'model_name': 'Unet_deeper', 'optimizer_name': 'rmsprop', 'learning_rate': 1.2870E-05, 'dropout_rate': 0.15, 'l2_lambda': 2.2284E-05, 'activation_function': 'relu', 'loss_function': 'binary_crossentropy', 'momentum': 0.6},
    {'model_name': 'Unet_deep', 'optimizer_name': 'sgd', 'learning_rate': 1.0836E-04, 'dropout_rate': 0.15, 'l2_lambda': 5.4708E-03, 'activation_function': 'relu', 'loss_function': 'binary_crossentropy', 'momentum': 0.8},
    {'model_name': 'Unet_simple', 'optimizer_name': 'sgd', 'learning_rate': 4.6655E-04, 'dropout_rate': 0.3, 'l2_lambda': 1.2641E-03, 'activation_function': 'leaky_relu', 'loss_function': 'binary_crossentropy', 'momentum': 0.3}
]


    # Directory to save results
    result_dir = 'results/learning/nested_set_1'
